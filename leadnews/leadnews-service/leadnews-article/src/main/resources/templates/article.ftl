...
<head>
    ...
    <title>智趣头条</title>
    <!-- 引入样式文件 -->
    <link rel="stylesheet" href="https://cdnjs.cloudflare.com/ajax/libs/vant/2.12.47/index.css">
    <!-- 页面样式 -->
...
<script src="https://cdnjs.cloudflare.com/ajax/libs/vant/2.12.47/vant.min.js"></script>
<!-- 引入 Axios 的 JS 文件 -->
